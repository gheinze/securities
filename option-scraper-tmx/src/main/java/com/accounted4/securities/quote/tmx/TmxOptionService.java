...
public class TmxOptionService {
    ...
    private static final String SERVICE_NAME = "TMX Option Quotes";
    ...
    public OptionChain getOptionChain(String symbol) throws SAXException, IOException {
        ...
        //urlString = "file:///home/gheinze/CODE/securities/stock-quote-tmx/src/test/java/tmxOptionResult.html";
...
//        OptionChain optionChain = service.getOptionChain("BMO");
        System.out.println("\n\n\n");
